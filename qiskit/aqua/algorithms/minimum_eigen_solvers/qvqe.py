...
## define a new vqe using entanglement
## a new optimizer may be developed to encode the entanglemnt, to be done
## not finished yet, Apr 15, 2020


class QVQE(VQAlgorithm, MinimumEigensolver):
    r"""
    The Variational Quantum Eigensolver algorithm.
